...
public class JwtTokenUtil {
    ...
    public String createToken(String username) {
        ...
        claims.put("customerId", customer.getCustomerId()); // Add customerId as a claim
        claims.put("customerName", customer.getCustomerName()); // Add customerName as a claim
    ...
    // Additional methods for validating and parsing the token can be added here
}
